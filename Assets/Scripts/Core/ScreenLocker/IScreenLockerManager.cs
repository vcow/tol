...
namespace Core.ScreenLocker
{
	...
	public interface IScreenLockerManager
	{
		...
		/// <param name="baseScreenLockerPrefab">A prefab of the screen locker window.</param>
		void SetScreenLocker(LockerType type, BaseScreenLocker baseScreenLockerPrefab);
	}
}